...
TEST_DATA = yaml(`
- desc: simple object
  expect: {"tables":{"hoges":{"name":"hoges","altname":"","columns":{"bbb":{"name":"bbb","type":"number", "foreign": null},"aaa":{"name":"aaa","type":"string", "foreign": null}}}}}
  name: Hoge
  input: |
    openapi: 3.0.1
    info:
...
- desc: allOf object
  expect: {"tables":{"hoges":{"name":"hoges","altname":"","columns":{"bbb":{"name":"bbb","type":"integer", "foreign": null},"aaa":{"name":"aaa","type":"string", "foreign": null}}}}}
  name: Hoge
  input: |
    openapi: 3.0.1
    info:
